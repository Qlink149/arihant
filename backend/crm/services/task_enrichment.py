...
SLA_REASON_BY_KEY: Dict[tuple, str] = {
    ...
    ("rnr", "escalate_d7"): "RNR lead unreachable for 6 days across two agents.",
    ("rnr", "reminder_a1"): "RNR — retry call (day 1 of 3).",
    ("rnr", "reminder_a2"): "RNR — retry call (day 2 of 3).",
    ("rnr", "reminder_a3"): "RNR — retry call (day 3 of 3).",
    ("rnr", "reminder_b1"): "RNR — retry call (day 1 of 3).",
    ("rnr", "reminder_b2"): "RNR — retry call (day 2 of 3).",
    ("rnr", "reminder_b3"): "RNR — retry call (day 3 of 3).",
    ...
    ("sv_followup_1", "entry"): "SV Follow-up — confirm booking intent.",
    ("sv_followup_1", "escalate_72h"): "SV Follow-up task pending 72 hours.",
    ("sv_followup_2", "20d"): "SV Follow-up 2 — 20-day follow-up due; admin notified.",
    ("sv_followup_2", "entry"): "SV Follow-up 2 — move towards decision.",
    ...
    ("interested", "followup_7d"): "Follow up — confirm visit date or reassess lead.",
